...
~/iris/ai.knowledge/rules/livekit-rust-sdks/INDEX.md  (if exists)
~/iris/ai.knowledge/knowledge/global/INDEX.md
~/iris/ai.knowledge/knowledge/livekit-rust-sdks/INDEX.md  (if exists)
```
...
Agent mistake → `/iris-rule global|livekit-rust-sdks {rule}`
Explained something new → `/iris-learn global|livekit-rust-sdks {context}`
